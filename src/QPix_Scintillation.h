...
#ifndef QPix_Scintillation_h
#define GPix_Scintillation_h 1
...
class QPix_Scintillation : public G4VRestDiscreteProcess
{
 public:
  explicit QPix_Scintillation(const G4String& processName = "Scintillation",
                           G4ProcessType type          = fElectromagnetic);
  ~QPix_Scintillation();

  QPix_Scintillation(const QPix_Scintillation& right) = delete;
  QPix_Scintillation& operator=(const QPix_Scintillation& right) = delete;
  std::ofstream file;

  G4GenericMessenger* scint_mesg_;
  G4double electricField_ = 0;
  // QPix_Scintillation Process has both PostStepDoIt (for energy
  ...
  // If set, the QPix_Scintillation process expects the user to have
  ...
  // Call by the user to set the QPix_ScintillationTrackInformation
  // to scintillation photon track

  G4bool GetScintillationTrackInfo() const;
  // Return the boolean for whether or not the
  // QPix_ScintillationTrackInformation is set to the scint. photon track
...
inline G4bool QPix_Scintillation::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline G4bool QPix_Scintillation::GetFiniteRiseTime() const
{
  return fFiniteRiseTime;
}

inline G4PhysicsTable* QPix_Scintillation::GetIntegralTable1() const
{
  return fIntegralTable1;
}

inline G4PhysicsTable* QPix_Scintillation::GetIntegralTable2() const
{
  return fIntegralTable2;
}

inline G4PhysicsTable* QPix_Scintillation::GetIntegralTable3() const
{
  return fIntegralTable3;
}

inline void QPix_Scintillation::AddSaturation(G4EmSaturation* sat)
{
  fEmSaturation = sat;
}

inline void QPix_Scintillation::RemoveSaturation() { fEmSaturation = nullptr; }

inline G4EmSaturation* QPix_Scintillation::GetSaturation() const
{
  return fEmSaturation;
}

inline G4bool QPix_Scintillation::GetScintillationByParticleType() const
{
  return fScintillationByParticleType;
}

inline G4bool QPix_Scintillation::GetScintillationTrackInfo() const
{
  return fScintillationTrackInfo;
}

inline G4bool QPix_Scintillation::GetStackPhotons() const { return fStackingFlag; }

inline G4int QPix_Scintillation::GetNumPhotons() const { return fNumPhotons; }

inline G4double QPix_Scintillation::single_exp(G4double t, G4double tau2)
{
  return std::exp(-1.0 * t / tau2) / tau2;
}

inline G4double QPix_Scintillation::bi_exp(G4double t, G4double tau1,
                                        G4double tau2)
{
