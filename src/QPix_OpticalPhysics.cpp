...
G4_DECLARE_PHYSCONSTR_FACTORY(QPix_OpticalPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
QPix_OpticalPhysics::QPix_OpticalPhysics(G4int verbose, const G4String& name)
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
QPix_OpticalPhysics::~QPix_OpticalPhysics() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_OpticalPhysics::PrintStatistics() const
{
  G4OpticalParameters::Instance()->Dump();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_OpticalPhysics::ConstructParticle()
{
  G4OpticalPhoton::OpticalPhotonDefinition();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_OpticalPhysics::ConstructProcess()
{
  if(verboseLevel > 0)
    G4cout << "QPix_OpticalPhysics:: Add Optical Physics Processes" << G4endl;
  ...
  if(!pManager)
  {
    ...
    G4Exception("QPix_OpticalPhysics::ConstructProcess()", "", FatalException, ed);
    return;
  }
  ...
  QPix_Scintillation* scint       = new QPix_Scintillation();
  ...
  while((*myParticleIterator)())
  {
    ...
    if(!pManager)
    {
      ...
      G4Exception("QPix_OpticalPhysics::ConstructProcess()", "", FatalException,
                  ed);
