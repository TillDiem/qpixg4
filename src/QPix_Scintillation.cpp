...
QPix_Scintillation::QPix_Scintillation(const G4String& processName,
                                 G4ProcessType type)
  ...
  , fNumPhotons(0)
{
  ...
  file.open("Scintillation_Verbose_LogData.dat");
  Initialise();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
QPix_Scintillation::~QPix_Scintillation()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::ProcessDescription(std::ostream& out) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool QPix_Scintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::PreparePhysicsTable(const G4ParticleDefinition&)
{
  Initialise();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::Initialise()
{
  G4OpticalParameters* params = G4OpticalParameters::Instance();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::BuildPhysicsTable(const G4ParticleDefinition&)
{
  if(fIntegralTable1 != nullptr)
  {
    fIntegralTable1->clearAndDestroy();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* QPix_Scintillation::AtRestDoIt(const G4Track& aTrack,
                                               const G4Step& aStep)
// This routine simply calls the equivalent PostStepDoIt since all the
// necessary information resides in aStep.GetTotalEnergyDeposit()
{
  return QPix_Scintillation::PostStepDoIt(aTrack, aStep);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* QPix_Scintillation::PostStepDoIt(const G4Track& aTrack,
                                                 const G4Step& aStep)
...
// evenly along the track segment and uniformly into 4pi.
{
  ...
  {
    // LArQL is usable only for MIP's, so we have to check if the particle is one (Paper says below 40MeV/cm)
    G4bool MIP = ((TotalEnergyDeposit / CLHEP::MeV)/(StepWidth / CLHEP::cm) < 40);
    if(MIP){
      //Get yield1,2,3 from the MaterialPropertiesTable
      MeanNumberOfPhotons = GetScintillationYieldByParticleType(aTrack, aStep, yield1, yield2, yield3);
      // Set MeanNumberOfPhotons
      MeanNumberOfPhotons = LArQL_MeanNumberPhotons(TotalEnergyDeposit/CLHEP::MeV,StepWidth/CLHEP::cm,electricField_)*(TotalEnergyDeposit/CLHEP::MeV);
      ...
      G4cout << " --------------------------------------------- " << G4endl;
      G4cout << "Using LArQL; predicting " << MeanNumberOfPhotons << " photons in ScintByParticle due to " << G4endl;
      G4cout << "Particle: " << aStep.GetTrack()->GetDynamicParticle()->GetParticleDefinition()->GetParticleName() << G4endl;
      G4cout << "LightYield: " << MeanNumberOfPhotons/(TotalEnergyDeposit/CLHEP::MeV) << " photons/MeV" << G4endl;
  ...
  if(verboseLevel > 1)
  {
    G4cout << "\n Exiting from QPix_Scintillation::DoIt -- NumberOfSecondaries = "
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double QPix_Scintillation::GetMeanFreePath(const G4Track&, G4double,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double QPix_Scintillation::GetMeanLifeTime(const G4Track&,
                                          G4ForceCondition* condition)
{
  *condition = Forced;
  return DBL_MAX;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double QPix_Scintillation::sample_time(G4double tau1, G4double tau2)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double QPix_Scintillation::GetScintillationYieldByParticleType(
  ...
  G4double& yield2, G4double& yield3)
{
  ...
  if(!yieldVector)
  {
    ...
    ed << "\nQPix_Scintillation::PostStepDoIt(): "
    ...
    G4Exception("QPix_Scintillation::PostStepDoIt", "Scint01", FatalException, ed,
                comments);
  }
  ...
  {
    G4ExceptionDescription ed;
    ed << "\nQPix_Scintillation::GetScintillationYieldByParticleType(): Request\n"
    ...
    G4Exception("QPix_Scintillation::GetScintillationYieldByParticleType()",
  ...
  G4cout << "\n--- QPix_Scintillation::GetScintillationYieldByParticleType() ---\n"
         << "--\n"
         << "--  Name         =  "
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::DumpPhysicsTable() const
{
  if(fIntegralTable1)
  {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::SetTrackSecondariesFirst(const G4bool state)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::SetFiniteRiseTime(const G4bool state)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::SetScintillationByParticleType(const G4bool scintType)
{
  if(fEmSaturation && scintType)
  {
    G4Exception("QPix_Scintillation::SetScintillationByParticleType", "Scint02",
                JustWarning,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::SetScintillationTrackInfo(const G4bool trackType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::SetStackPhotons(const G4bool stackingFlag)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void QPix_Scintillation::SetVerboseLevel(G4int verbose)
{
